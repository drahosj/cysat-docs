...
vConsolePrintf should be used for console printfs, reserving explicit UART1
and UART2 access for situations where it actually matters.
...
call getMissionTime() to return a time_t of the mission time (seconds since first
power-on).